...
public class MyListDataStatus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_list_data_status);
        ...
        reference.child("Admin").child(getJENIS)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        adapter = new RecyclerViewAdapterStatus(dataMahasiswa, MyListDataStatus.this);
